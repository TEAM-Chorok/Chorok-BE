...
public class BloomingController {
    ...
    return ResponseEntity.status(HttpStatus.OK).body(bloomingService.createBloomingDay(myPlantNo,thatDay,userDetails));
    }
